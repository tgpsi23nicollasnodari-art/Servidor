...
Aqui é onde guardamos os **Mapas Customizados**, **Assets** e a própria alma do servidor.
...
## 🎨 Visual das Classes & Editor
| Classes Elementais | Editor de Mundos |
| :---: | :---: |
| ![Personagens](character_showcase.png) | ![Editor](map_editor.png) |

---

## 🛠️ Tecnodogias & Links
- 🌐 [Acesse o Site Oficial](https://tgpsi23nicollasnodari-art.github.io/Servidor/) (Em breve)
- 🕯️ [Taverna das Sombras (Comunidade)](comunidade.html)
- 🎮 [Download do Jogo](index.html#downloads)

---

<p align="center">
  <i>"O RPG open source feito para a comunidade. Código livre, mentes livres."</i>
</p>
